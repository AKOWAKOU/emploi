...
def get_timetable_data(level_id: Optional[int], current_week: bool = False, week = None):
...
def get_timetable_user(user_id : Optional[int], current_week : bool = False, week = None):
